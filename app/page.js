    ...
    <div className="min-h-screen bg-[#0b0b0d] text-white">
      ...
      <header className="sticky top-0 z-50 backdrop-blur bg-black/50 border-b border-white/10">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <div>
              <div className="font-bold tracking-tight">Netrik Shop</div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0">
          <img src={HERO} className="w-full h-full object-cover opacity-30" alt="hero"/>
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/70 to-[#0b0b0d]"/>
        </div>
        <div className="relative container mx-auto px-6 pt-24 pb-32 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-xs uppercase tracking-widest text-amber-300">
            <Sparkles className="h-3.5 w-3.5"/> AI-powered Restaurant Suite
          </div>
          <h1 className="mt-8 text-5xl md:text-7xl font-black tracking-tight leading-[1.05]">
          ...
          <p className="mt-6 max-w-2xl mx-auto text-lg text-white/70">
            QR-table ordering, an AI waiter that speaks like a human, real-time kitchen tickets in English & Spanish, and analytics that drive revenue — all in one beautiful platform.
          </p>
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link href="/login"><Button size="lg" className="bg-amber-400 text-black hover:bg-amber-300 font-semibold h-12 px-8">Get Started <ArrowRight className="ml-2 h-4 w-4"/></Button></Link>
            <a href="#features"><Button size="lg" variant="outline" className="h-12 px-8 border-white/30 bg-white/5 text-white hover:bg-white/10">See features</Button></a>
          </div>
